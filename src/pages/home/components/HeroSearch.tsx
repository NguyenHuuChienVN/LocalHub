...
export default function HeroSearch() {
	...
	return (
		<section className="overflow-hidden rounded-2xl bg-cover bg-center px-6 py-10 max-sm:rounded-[19px] max-sm:px-[18px] max-sm:py-6 md:px-12" style={{ backgroundImage: "url('/bg-header.png')" }}>
			<div className="max-w-xl">
				<p className="mb-3 inline-flex rounded-full bg-blue-600/80 px-3 py-1.5 text-xs font-bold text-white"><span className="mr-1">⚡</span> Kết nối nhanh trong 5 phút</p>
				<h1 className="text-4xl font-black leading-tight text-slate-950 max-sm:text-[23px] max-sm:leading-[1.2] md:text-5xl">Dịch vụ địa phương<br className="max-sm:block" /> nhanh chóng &amp; tin cậy</h1>
				<p className="mt-4 max-w-lg text-base leading-7 text-slate-600 max-sm:mt-3 max-sm:text-[13px] max-sm:leading-5">Kết nối với các chuyên gia địa phương uy tín. Giá cả minh bạch.</p>

...
const registerSchema = z.object({
	...
	password: z.string().min(6, "Mật khẩu cần có ít nhất 6 ký tự bao gồm cả chữ và số").regex(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,}$/, "Mật khẩu cần có ít nhất 6 ký tự bao gồm cả chữ cái đâì viết hoa, ký tự đặc biệt và số "),
